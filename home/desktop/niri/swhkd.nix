{
  ...
  xdg.configFile."niri/swhkd/niri.swhkdrc".text = with snowy.swhkd;
    mkSwhkdrc {
      includes = [
        "${config.xdg.configHome}/swhkd/basic.swhkdrc"
        "${config.xdg.configHome}/noctalia/swhkd/noctalia.swhkdrc"
      ];
      keyBindings = [
