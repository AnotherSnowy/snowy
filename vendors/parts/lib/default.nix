  ...
  */
  ...
  flake-parts-lib = rec {
    ...
    */
    ...
    importApply = modulePath: staticArgs: lib.setDefaultModuleLocation modulePath (import modulePath staticArgs);

    inherit
      (import ./memoize/memoize.nix {
        inherit lib;
      })
      memoizeStr
      ;
...
in
  ...
  then
    abort ''
      ...
      but the actual version is ${lib.version}${rev}.
    ''
